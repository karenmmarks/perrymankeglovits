...
const SpiritAwards = () => {
  const spiritWinner = [
    ...
    },
    {
      ...
      year: '2017',
      name: 'Rich Osswald',
      spiritInfo: ['Richard “Ozzie” Osswald, an all-around athlete created and published the popular local sports newspaper, Pocono Sports Extra which later became the  Lehigh Valley & Pocono Sports Extra.',
        'Rich loved sports and ran cross country, track, played soccer, baseball, basketball, and was a college wrestler and tennis player, but his favorite sport was swimming, especially masters level swimming and ocean swimming as a member of the La Jolla Cove Swim Club in California. Rich and his family enjoyed boating and water skiing on Lake Wallenpaupack for 15 years, and snow skiing with his son, Bret, in Park City, Utah.',
        'Rich was a former Executive Director of the Pocono Family YMCA where he founded the first countywide youth soccer program with local soccer legend, Dale Marsh; the first age group swim team in the late 1976 and a Masters level competitive swim teams in 1980, all three of which are still in existence today. He developed the first pre-natal aquatic fitness program in the United States with Dr. DeQuevedo.',
        'Rich was also Chief Operating Officer of Shawnee Services, Inc., and Director of Development at RKR Hess Associates. Over the years, Rich was a volunteer Meals-On-Wheels driver, a past Pocono Mountain Chamber of Commerce Education Committee chairman. He served as a Stroudsburg Borough councilman, and was a member of the planning commission and zoning hearing board. Rich was a volunteer coach for youth athletics for over 25 years.',
      ],
      component: null,
    },
    {
      ...
      year: '2016',
      name: 'John Marvin',
      spiritInfo: ['John Marvin has always had basketball in his blood playing ball all four years at Stroudsburg High School. Upon graduation in 1969 he entered the U.S. Army National Guard and served a 6 year tour from 1970 through 1976.',
        'After the service, John took the P.I.A.A. Basketball Officals Exam and joined the Stroudsburg Chapter serving as president in 1988 for thirteen years.',
        'Throughout his 38 year career he has sought to constantly improve by attending and working at a myriad of basketball camps. John’s experiences include an amazing over 1500 games officiated at the high school and Division III Levels.',
        'Officiating has been very rewarding to John and has brought forth many new friendships in Monroe County, the Lehigh Valley, Scranton and Wilkes Barre.',
        'John says, “I will stay a fan of basketball and continue to attend as many games as I can”.',
        '“The Perryman Keglovits Spirit of Basketball Award is very special to me because it does immortalize the Spirit and determination of all those who fight cancer.”',
        '“Cancer took my wife, Ellen\'s Life in August of 2015, but not without a battle!”',
    ...
    },
    {
      key: '9',
      year: '2011',
      name: 'Community Inspiration Award',
      spiritInfo: ['The Perryman Keglovits Foundation would like recognize you for the inspiration you give to our community and to your peers through your positive work in the classroom and through the many activities in which you are involved. "Don\'t ever give up in your Life Journey". You are certainly an inspiration to us all.'],
      component: (
        <div className="container">
          <div className="row flex">
            <div className="col">
              <h3>Kaitlin Gonzalez</h3>
              <h4>East Stroudsburg North High School</h4>
              <ul>
                <li>All American Cheerleader</li>
                <li>JV Cheerleader All 4 Years in High School</li>
                <li>Honor Roll all 4 years in HS</li>
                <li>National Honor Society 3 years</li>
                <li>Currently President National Honor Society</li>
                <li>Chorus 4 years</li>
                ...
                <li>Yearbook</li>
                <li>Leo Club</li>
                <li>S.T.O.P. Abuse Club</li>
                <li>Top 10%of her class</li>
                <li>Hall Decorating</li>
                <li>Relay for Life</li>
              </ul>
            </div>
            <div className="col">
              <h3>Tarik Williams</h3>
              <h4>Pleasant Valley High School</h4>
              <ul>
                <li>Played Basketball 2 years Varsity</li>
                <li>Honor Student all 4 years</li>
                <li>Marching Band</li>
                <li>Section Leader</li>
                <li>Involved in School Musicals</li>
                <li>F.B.L.A.</li>
                <li>Homecoming King 2010-2011</li>
                <li>Vice President of the Debate Team</li>
                <li>Varsity Choral</li>
                <li>Varsity Track</li>
              </ul>
            </div>
          </div>
    ...
    },
    {
      ...
      spiritInfo: ['Robert W. Kennedy of Keyport, NJ and his trusted companion Patricia Geary of Red Bank, NJ married and came to Cherry Valley, Stroudsburg in 1963.They arrived on “White Horses” or should I say, they tied their luggage to the top of their old battered car and settled at the old YMCA Camp, Camp Dent on Featherman Rd. Upon getting out of the car they discovered there luggage on the top of their car was lost. Bob had no money but managed to pay the tolls to go back to New Jersey to find their luggage or so the story goes, said Bob’s mom, to start this adventure. Here begins the story of one of the largest and most courageous basketball stories ever told. “The Beaver” that’s Basketball Bob (he never, never, never quit) and “The Princess” that’s Patty both had tremendous basketball foresight. Patty was a nurse with a tremendous love for people and a degree in nursing. Who would ever think their careers could work, so well, together to build, discover and pioneer the growth of both boys and girls basketball not only in Monroe County but in the United States.',
        ...
        'We could go on and on but I do want to mention the avenues both Bob and Patty took and unselfishly forged:',
    ...
    },
    {
      key: '16',
      year: '2004',
      name: 'Bill & Bonnie White',
      spiritInfo: ['He has coached basketball for 36 years. She has kept score at basketball games for 30 years. It all comes together each year as Bill and Bonnie White run the annual Greater Pocono Basketball Tournament for youngsters from fifth to eigth grades. More than 10,000 boys and girls have taken part in the tournament in its 32-year-old history.',
        'This year\'s event started Feb. 28th with 46 teams in four divisions and will conclude with championship and consolation round games Saturday. The Whites will be honored for their dedication and commitment to the sport of basketball and the you of the community when they jointly receive the Al Keglovits Spirit of Basketball Award Sunday. The presentation will take place between games of the second annual Arthur Perryman All-Star Basketball Classic at East Stroudsburg University\'s Koehler Fieldhouse. The top area high school senior players will compete in a girls\' game at 3 pm and a boys\' contest at 5.',
        'The whites took different routes to the basketball floor at the Stroudsburg Junior High School where the Greater Pocono tournament is now played.',
            ...
            <div className="col-lg-12 mx-auto">
              ...
              <Accordion>
                {spiritWinner.map((spiritContent) => {
                  const {
                    key, year, name, spiritInfo, component,
                  } = spiritContent;
                  return (
                    <>
                      <Card>
