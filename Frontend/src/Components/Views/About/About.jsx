    ...
    <div className="container page">
        ...
        <div className="box">
          <div className="col-lg-12 mx-auto">
            ...
            <p>
              ...
              and my family in regards to starting an all-star game in Arthur's name for
            ...
            <p>
              Arthur left us way too early on April 21, 1995. When we say "us" we include all
              of the lives in which Art touched during his 19 years of life. During my family's
              mourning, we were utterly supported by the community in every way possible. Truly
              there was not a day that passed in which someone did not reach out to offer an ear
              to listen, to share a personal story they had with Art or to just simply say how
              sorry they were for our loss.
            </p>
            <blockquote className="blockquote">
              Over the years, our appreciation for our community has strengthened and words cannot
              express enough our gratitude for the continuous support in keeping Arthur's memory,
              along with Al's, and legacy alive through this prestigious event. This All-Star game
            ...
            <p>
              ...
              an arena in which he loved most - the basketball court. My family and I are so
              appreciative for the many efforts that go into this game each year to improve its
              quality and for those who continue to support the cause. Artie is definitely looking
              down on us and proud of what we came together as a community to accomplish in his
              name.
            </p>
            <br />
            <p>
          ...
          <div className="col-lg-12">
            ...
            <div className="col-lg-12 text-center">
              ...
              <p className="text-left">
                ...
                providing the vehicle of an all-star basketball game in partnership
                with area businesses, institutions, and agencies.
              </p>
              <p className="text-left">
                The Perryman and Keglovits All-Star Tribute Game celebrates the lives
                of local basketball stars Arthur Perryman and Al Keglovits, and all
            ...
            <div className="col-lg-12 text-center">
              <p className="text-left">
                <strong>
                  Our mission to celebrate the lives of those who have fought
                  the battle of cancer is an important one to us.
                </strong>
              </p>
            </div>
          </div>
      ...
      <div className="row">
        <div className="box">
          ...
          <img className="img-responsive float-right ml-2" src={IMAGES.AL} alt="Al Keglovits" />
          <p>
            Al Keglovits was a father, a husband, a teacher, a coach, a bartender,
            a comedian, a New York Yankees fan, a golfer, and a friend to all who
            knew him. Al Keglovits, was one of those guys who had a dynamic personality.
            Kids, colleagues and all opponents were drawn towards his magnetic charm.
            Al drew you closer to him.
          </p>
          <p>
            Fighting Cancer, seeing how he fought it was an inspiration to all of us.
            He knew he had a fight on his hands when he was diagnosed with cancer.
            He fought it right up to the end. He never, never quit. Unfortunately
            he couldn't rally one more time.
          </p>
          <p>
            What is important is what the Man, Al Keglovits, did with his life.
            The example set was one of courage. He loved his Family, he loved his
            friends and he loved Basketball. Coaching and teaching were instinctive
            for Keglovits. He will be remembered by all his players, friends, those
            he toasted life to. Coach Keglovits, will always be remembered for his
            tremendous ever so dry sense of humor. He was one of those guys you always
            wanted to be around. Al made you feel comfortable but watch out for the
            next zinger, it was probably going to be aimed at you. Among all of his
            positive traits, Al Keglovits will be most remembered by his family and
            friends for his sense of humor and his love for the game of basketball.
          </p>
        </div>
      </div>
      ...
      <div className="row">
        <div className="box">
          ...
          <img className="img-responsive float-left mr-2" src={IMAGES.ART} alt="Arthur Perryman" />

          <p>
            Loved and cared for all his peers, Arthur never used profanity; he was
            gentle, kind and loving. I never once heard anyone say anything negative
            about him. He was unselfish and thought of others before himself. His
            family was very important to him. He was a caring, thoughtful brother
            and son. Arthur was never alone, always with his friends or his sisters.
          </p>
          {' '}
          <p>
            {' '}
          ...
          <ul className="arthur overflow-hidden">
            ...
            <li>
              Started all 105 varsity basketball games during his 4 year career
      ...
      <div className="row d-block">
        <div className="box">
          <div className="col-lg-12">
            ...
            {/* <!-- <img class="img-responsive" src="images/photos/2015_game/2015
            All Stars_6416.JPG" alt="">--> */}
          </div>
        </div>
      </div>
